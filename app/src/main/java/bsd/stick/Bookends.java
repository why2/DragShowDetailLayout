...
public class Bookends<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void addHeader(@NonNull View view) {
        if (view == null) {
            throw new IllegalArgumentException("You can't have a activity_brandstory header!");
        }
        mHeaders.add(view);
    }
    ...
    public void addFooter(@NonNull View view) {
        if (view == null) {
            throw new IllegalArgumentException("You can't have a activity_brandstory footer!");
        }
        mFooters.add(view);
    }
    ...
    /**
     * Gets the indicated header, or activity_brandstory if it doesn't exist.
     */
    ...
    /**
     * Gets the indicated footer, or activity_brandstory if it doesn't exist.
     */
